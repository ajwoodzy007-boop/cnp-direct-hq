...
import { BookOpenIcon, ArrowTopRightOnSquareIcon, ShieldCheckIcon, BoltIcon, ArrowTrendingUpIcon, ArrowPathIcon, SignalIcon, DocumentTextIcon, XMarkIcon, ChevronRightIcon, ViewfinderCircleIcon, ChartBarIcon, CalculatorIcon } from '@heroicons/react/24/outline';
...
export default function TheAcademy() {
  ...
  const resources = [
    { name: "TradingView Charts", desc: "Advanced Charting Software", link: "#", icon: ArrowTrendingUpIcon },
    { name: "Partner Integrations", desc: "Coming Soon", link: "#", icon: BoltIcon },
    { name: "News & Data Partners", desc: "Coming Soon", link: "#", icon: ShieldCheckIcon },
  ];
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="border-b border-slate-800 pb-6">
        <h2 className="text-3xl font-bold text-white flex items-center gap-3">
          <BookOpenIcon className="text-amber-400 h-8 w-8" />
          The Academy
        </h2>
      ...
      <div className="bg-slate-900 border border-slate-700 rounded-xl overflow-hidden relative group">
        ...
        <div className="bg-slate-950 px-6 py-4 border-b border-slate-800 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <SignalIcon className={`h-5 w-5 ${loading ? 'text-slate-500' : 'text-red-500 animate-pulse'}`} />
              ...
              >
                ...
                <div>
                  <div className="font-bold text-white group-hover:text-amber-400 flex items-center gap-2">
                    {res.name} <ArrowTopRightOnSquareIcon className="h-3 w-3 opacity-50" />
                  </div>
            ...
            return (
              ...
              >
                ...
                <div className="text-xs text-slate-500 mt-2 flex items-center gap-1">
                  {manual.sections.length} lessons <ChevronRightIcon className="h-3 w-3" />
                </div>
              </div>
            );
          })}
