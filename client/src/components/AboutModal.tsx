...
import { 
  XMarkIcon, ShieldCheckIcon, SignalIcon, ViewfinderCircleIcon, CpuChipIcon, BriefcaseIcon, BookOpenIcon, 
  ArrowTrendingUpIcon, BoltIcon, CheckCircleIcon, StarIcon, ArrowRightIcon, SparklesIcon, ClockIcon, 
  ChartBarIcon, LockClosedIcon, ChevronDownIcon, ChevronUpIcon, UsersIcon, 
  ChartBarSquareIcon, ExclamationTriangleIcon, GiftIcon
      ...
      <div className="min-h-full flex items-start justify-center p-4 py-8">
        ...
        <div className="p-6 md:p-8 space-y-10">
          ...
          <div className="bg-gradient-to-r from-amber-900/30 via-amber-800/20 to-amber-900/30 border border-amber-500/40 rounded-xl p-4 flex items-center gap-3">
            <GiftIcon className="h-6 w-6 text-amber-400 shrink-0" />
          ...
          <div>
            <h2 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
              <ChartBarSquareIcon className="h-5 w-5 text-cyan-400" />
              How It Works
            </h2>
                ...
                <div key={i} className="bg-slate-800/50 border border-slate-700 rounded-xl p-5">
                  <div className="flex items-center gap-0.5 mb-3">
                    {[...Array(testimonial.rating)].map((_, j) => (
                      <StarIcon key={j} className="h-4 w-4 text-amber-400 fill-current" />
                    ))}
                  </div>
          ...
          <div className="bg-slate-800/30 border border-slate-700 rounded-xl p-6 text-center">
            ...
            {!isLoggedIn && onSignUp ? (
              ...
              <button
                ...
                className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-bold rounded-lg inline-flex items-center gap-2 transition-all shadow-lg shadow-cyan-500/20"
              >
                Explore the Platform <ArrowRightIcon className="h-5 w-5" />
              </button>
            )}
          </div>
